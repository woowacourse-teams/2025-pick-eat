...
public class S3ImageUploadClient implements ImageUploadClient {
    ...
    @Override
    public String uploadImage(MultipartFile file, String uploadKey) {
        try {
