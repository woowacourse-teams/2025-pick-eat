    ...
    public void run(String... args) {
        if (!userRepository.existsByNickname("운영자")) {
            ...
            Wish jamsilWish2 = wishRepository.save(new Wish("육회바른연어", FoodCategory.JAPANESE,
                    "서울 송파구 올림픽로35가길 11 한신코어오피스텔 1층 103호", "연어, 육회, 덮밥, 초밥", "https://place.map.kakao.com/505348601",
                    jamsilWishList));
            wishPictureRepository.save(
            ...
            Wish jamsilWish3 = wishRepository.save(new Wish("연어식당", FoodCategory.JAPANESE,
                    "서울 송파구 올림픽로35가길 9 잠실푸르지오월드마크 1층", "연어, 덮밥", "https://place.map.kakao.com/505348601",
                    jamsilWishList));
            wishPictureRepository.save(
            ...
            Wish jamsilWish4 = wishRepository.save(new Wish("성화마라탕", FoodCategory.CHINESE,
                    "서울 송파구 올림픽로35가길 9 지하1층 39,40호", "마라탕, 마라샹궈, 꿔바로우", "https://place.map.kakao.com/505348601",
                    jamsilWishList));
            wishPictureRepository.save(
            ...
            Wish jamsilWish5 = wishRepository.save(new Wish("맥도날드", FoodCategory.OTHERS,
                    "서울 송파구 송파대로 558 월드타워빌딩 1층", "햄버거", "https://place.map.kakao.com/505348601", jamsilWishList));
            wishPictureRepository.save(
            ...
            Wish jamsilWish6 = wishRepository.save(new Wish("홍수계찜닭", FoodCategory.KOREAN,
                    "서울 송파구 송파대로 570 타워730 지하1층", "찜닭", "https://place.map.kakao.com/505348601", jamsilWishList));
            wishPictureRepository.save(
            ...
            Wish seolleungWish2 = wishRepository.save(new Wish("반포식스", FoodCategory.OTHERS,
                    "서울 강남구 선릉로 518 2,3층", "쌀국수", "https://place.map.kakao.com/505348601", seolleungWishList));
            ...
            Wish seolleungWish3 = wishRepository.save(new Wish("숯칼 선릉 손칼국수", FoodCategory.KOREAN,
                    "서울 강남구 삼성로91길 38 1층 숯칼 숯불닭구이 칼국수", "닭갈비, 칼국수", "https://place.map.kakao.com/505348601",
                    seolleungWishList));
            ...
            Wish seolleungWish4 = wishRepository.save(new Wish("신동궁감자탕뼈숯불구이 선릉직영점", FoodCategory.KOREAN,
                    "서울 강남구 선릉로86길 39 1층", "감자탕, 뼈숯불구이", "https://place.map.kakao.com/505348601", seolleungWishList));
            ...
            Wish seolleungWish5 = wishRepository.save(new Wish("친친", FoodCategory.CHINESE,
                    "서울 강남구 테헤란로63길 12 LG에클라트 B동 1층", "마라탕면, 가지덮밥, 짜장면", "https://place.map.kakao.com/505348601",
                    seolleungWishList));
            ...
            Wish seolleungWish6 = wishRepository.save(new Wish("명정루", FoodCategory.CHINESE,
                    "서울 강남구 테헤란로70길 12 1층", "중화덮밥, 짬뽕", "https://place.map.kakao.com/505348601", seolleungWishList));
            ...
            Wish seolleungWish7 = wishRepository.save(new Wish("참치여행", FoodCategory.JAPANESE,
                    "서울 강남구 테헤란로53길 22 성인빌딩 1층 101호", "초밥, 알밥, 회덮밥", "https://place.map.kakao.com/505348601",
                    seolleungWishList));
            ...
            Wish seolleungWish8 = wishRepository.save(new Wish("잇쇼우", FoodCategory.JAPANESE,
                    "서울 강남구 선릉로 524 선릉대림아크로텔 1층 109호", "돈카츠, 우동", "https://place.map.kakao.com/505348601",
                    seolleungWishList));
            ...
            Wish seolleungWish9 = wishRepository.save(new Wish("라피자노스트라", FoodCategory.WESTERN,
                    "서울 강남구 테헤란로 406 샹제리제센터 A동 1층 101호", "피자", "https://place.map.kakao.com/505348601",
                    seolleungWishList));
            ...
            Wish seolleungWish10 = wishRepository.save(new Wish("꾸우덕", FoodCategory.WESTERN,
                    "서울 강남구 선릉로82길 16 수이빌딩 1층", "파스타", "https://place.map.kakao.com/505348601", seolleungWishList));
