package com.pickeat.backend.global.stress.image_upload.v2;
...
public class StressImageUploadClientV2 implements ImageUploadClient {

    private final String defaultImageUrl;
    private final String keyPrefix;

    public StressImageUploadClientV2(String defaultImageUrl, String keyPrefix) {
